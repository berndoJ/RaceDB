...
<html>
  ...
  <head>
    <title>KK Time Database - Benutzermanagement</title>
    <meta charset="utf-8" />
        ...
        <div class="stdbox">
          ...
          <table class="deftable">
            ...
            function edit_user_click(user_id)
            {
              ...
              $.get("actions/get_username.act.php", {userid: edit_user_id}, function(data){
                $("#dialog_edit_user_username").text(data);
              });
              $.get("actions/get_user_permissionlevel.inc.php", {userid: edit_user_id, text: "set"}, function (data) {
            ...
            function delete_user_click(user_id)
            {
              ...
              $.get("actions/get_username.act.php", {userid: delete_user_id}, function(data){
